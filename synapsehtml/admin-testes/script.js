...
const activeClass = "text-[9px] font-mono tracking-[0.1em] px-2.5 py-1 border transition-colors border-alert/50 text-alert";
const inactiveClass = "text-[9px] font-mono tracking-[0.1em] px-2.5 py-1 border transition-colors border-border text-muted-foreground hover:text-foreground";
...
function bindModelButtons() {
  document.querySelectorAll("#model-buttons [data-model]").forEach((button) => {
    button.addEventListener("click", () => {
      document.querySelectorAll("#model-buttons [data-model]").forEach((item) => {
